                                ...
                                <div class="form-group" id="formroleuser">
                                    <div class="row">
                                        <div class="row text-center col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <input type="submit" class="btn btn-success" id="btnsave" onclick="tampilchart()" value="TAMPILKAN CHART">
                                            </div>
                                            <!-- <div class="col-md-4">
                                                <input type="submit" class="btn btn-success" id="btnnotif" onclick="kirimnotif()" value="notif wa">
                                            </div> -->
                                        </div>
...
<script>
    $(document).ready(function() {
        $("#branch").select2({
            ...
            allowClear: true,
            ajax: {
                url: "<?php echo e(route('pilihbranchnmu')); ?>",
                dataType: 'json',
                type: "POST",
                headers: {
    ...
    jQuery(document).ready(function($) {
        ...
        $('#branch').on("change", function(e) {
            ...
            $("#selunit").select2({
                ...
                allowClear: true,
                ajax: {
                    url: "<?php echo e(route('pilihunitnmu')); ?>",
                    dataType: 'json',
                    type: "POST",
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<script>
    function tampilchart() {
        ...
        $.ajax({
            url: "<?php echo e(route('datasetmnmu')); ?>",
            type: 'POST',
            data: {
                kdlokasi: $('#branch').val(),
                kode1: $('#selunit').val(),
...
<script>
    function kirimnotif() {
        ...
        $.ajax({
            ...
            data: {
                to: '6281336059196',
                message: "halo ini notifikasi uji coba dari aplikasi enigma, silahkan forward message ini dan kirim ke nomer 081216485798 untuk konfirmasi notifikasi masuk",
                "_token": "<?php echo e(csrf_token()); ?>"
            },
            ...
            error: function(error) {
                // Tampilkan notifikasi gagal menggunakan jQuery
...
<script>
    function tampilchartdiagnosa() {
        ...
        function drawChart() {
            $.ajax({
                url: "<?php echo e(route('datasetdiagnosamanajnmu')); ?>",
                type: 'POST',
                dataType: 'json',
                data: {
                    tglawal: tglawal,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\enigma\resources\views/dashboardmanajnmu.blade.php ENDPATH**/ ?>