                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="fv-row col-md-2">
                                    <input type="button" class="btn btn-success" id="btntable" value="TAMPILKAN DATA">
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        $("#selunit").select2({
            ...
            allowClear: true,
            ajax: {
                url: "<?php echo e(route('cmpilihunit')); ?>",
                dataType: 'json',
                type: "POST",
                headers: {
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tbdatabilling').DataTable({
            ...
            ajax: {
                url: "<?php echo e(route('cmdatatable')); ?>",
                'type': 'POST',
                data: function(d) {
                    d.kode1 = $('#selunit').val();
                },
        ...
        $('#tbdatabilling tbody').on('click', '#editdata', function() {
            ...
            console.log(idData)
            var kode1 = $('#selunit').val()
            $.ajax({
                url: "<?php echo e(route('cmparsingdatapasbil')); ?>",
                type: 'POST',
                data: {
                    kode1: kode1,
                    nori: idData,
        ...
        $('#btntable').click(function() {
            $('#tbdatabilling').DataTable().draw(true);
        });
    });
</script>
<script>
            ...
            validator.validate().then(function(status) {
                ...
                if (status == 'Valid') {
                    ...
                    if ($jenisbutton == "UPDATE INACBG'S") {
                        $.ajax({
                            url: "<?php echo e(route('cmupdateina')); ?>",
                            type: 'POST',
                            data: {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('cminsertina')); ?>",
                            type: 'POST',
                            data: {
                                idgrouper: $('#idgrouper').val(),
                                kode1: $kode1,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\enigma\resources\views/casemix/list_billing.blade.php ENDPATH**/ ?>