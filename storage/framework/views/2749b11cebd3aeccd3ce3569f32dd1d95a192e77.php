...
<script>
    function simpanedit() {
        if ($('#btnsave').val() != "SIMPAN") {
            $.ajax({
                url: "<?php echo e(route('updateunit')); ?>",
                type: 'POST',
                data: {
                    id: $('#id').val(),
...
<script>
    function del() {
        $.ajax({
            url: "<?php echo e(route('deleteunit')); ?>",
            type: 'POST',
            data: {
                id: $('#id').val(),
                "_token": "<?php echo e(csrf_token()); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\enigma\resources\views/msunit.blade.php ENDPATH**/ ?>