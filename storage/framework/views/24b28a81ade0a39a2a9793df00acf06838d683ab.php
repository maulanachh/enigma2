                                        ...
                                        <div id="kt_app_content" class="app-content flex-column-fluid">
                                            <div class="card-body">
                                                <div class="form-group" id="formroleuser">
                                                    ...
                                                    <input type="button" class="btn btn-danger" id="btnbatalnaik" onclick="batalnaikkelas()" value="BATAL NAIK KELAS" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.parsedatapasbil[0].icd10_1 == 'kosong') {
                        ...
                        if (res.parsedatapasbil[0].stts_naik !== 0) {
                            $('#klsrwt').append("<option value='" + res.parsedatapasbil[0].id_kelas + "' selected>" + res.parsedatapasbil[0].kls_naik + "</option>")
                            $('#btnbatalnaik').attr('disabled', false)
                        } else if (res.parsedatapasbil[0].stts_naik === 0) {
                            $('#klsrwt').empty().trigger('change')
                            $('#btnbatalnaik').attr('disabled', true)
                        }
                        $('#nmpasien').val(res.parsedatapasbil[0].nmpasien)
                        $('#nomrm').val(res.parsedatapasbil[0].nomrm)
                        $('#nori').val(res.parsedatapasbil[0].nori)
...
<script>
    function batalnaikkelas() {
        nori = $('#nori').val()
        $.ajax({
            url: "<?php echo e(route('batalnaikkelas')); ?>",
            type: 'POST',
            data: {
                nori: nori,
                "_token": "<?php echo e(csrf_token()); ?>"
            ...
            success: function(res) {
                toastr.success("Pembatalan Naik Kelas Sukses!")
                $('#icd10_1').empty().trigger('change'),
                    $('#icd10_2').empty().trigger('change'),
                    $('#icd10_3').empty().trigger('change'),
                    $('#icd10_4').empty().trigger('change'),
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\enigma\resources\views/ruangan/list_billing.blade.php ENDPATH**/ ?>