    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
                ...
                <div class="card rounded-3 w-md-550px">
                    ...
                    <div class="card-body p-10 p-lg-20">
                        ...
                        <div class="text-center mb-11">
                            <!--begin::Title-->
                            <img alt="Logo" src="<?php echo e(asset('img/ENIGMA ICON 2.png')); ?>" class="h-150px"> </img><br><br>
        ...
        <script>
            function login() {
                ...
                var pwd = $('#pwd').val()
                $.ajax({
                    url: "<?php echo e(route('fungsilogin')); ?>",
                    type: 'post',
                    dataType: "JSON",
                    data: {
                        username: username,
                    ...
                    success: function(res) {
                        if (res == 'nonmanajemen') {
                            window.location.href = "<?php echo e(route('dash')); ?>";
                            //alert();
                        } else if (res == 'manajemenrs') {
                            window.location.href = "<?php echo e(route('dashmanajemenrs')); ?>";
                        } else if (res == 'manajemennmu') {
                            window.location.href = "<?php echo e(route('dashmanajemennmu')); ?>";
                        } else if (res == 'kasir') {
                            window.location.href = "<?php echo e(route('indexkasir')); ?>";
                        }else {
                            window.location.href = "<?php echo e(('/')); ?>";
                        }
                    }
                })
            };
...
</html><?php /**PATH C:\laragon\www\enigma\resources\views/login.blade.php ENDPATH**/ ?>